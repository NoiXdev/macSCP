...
| [Verwaltungs-Sheets](superpowers/specs/2026-08-20-backlog-verwaltungs-sheets.md) | **Punkte 3 und 5 erledigt**, Punkt 4 verworfen. Das Drei-Punkte-Menü trägt inzwischen **drei** Sheets (Login-Sets, SSH-Schlüssel, Snippets); `AuditLogSheet` ist angeheftet ausgenommen. Der Wächter zählt die Sheets nicht mehr auf, sondern findet sie — er fand das dritte und das vierte sofort. **Offen: Punkt 2** (Facetten-Schnellfilter in Known-Hosts, Keys und Logins) und **Punkt 1** (Sitzung duplizieren, drei offene Fragen im Eintrag). |
