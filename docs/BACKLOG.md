...
| Eintrag | Kern |
|---|---|
| [Sitzungen, Tabs, Seitenleiste](superpowers/specs/2026-08-20-backlog-sitzungen-tabs-seitenleiste.md) | **Zehn von elf Punkten erledigt** (A1, A2, B1, B2, B3, C1, C2, D1+D2, D3, D4). Offen nur noch: Tags abschaltbar und als Filter (E1, E2 — zusammen zu entwerfen, zwei offene Fragen darin). |
