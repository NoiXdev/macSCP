...
| Eintrag | Kern |
|---|---|
| [Sitzungen, Tabs, Seitenleiste](superpowers/specs/2026-08-20-backlog-sitzungen-tabs-seitenleiste.md) | **Neun von elf Punkten erledigt** (A1, A2, B1, B2, B3, C1, C2, D1+D2, D4). Offen: Suche im Baum (D3, wartete auf D1), Tags abschaltbar und als Filter (E1, E2 — zusammen zu entwerfen). |
