...
| [Verwaltungs-Sheets](superpowers/specs/2026-08-20-backlog-verwaltungs-sheets.md) | **Punkte 1, 3 und 5 erledigt**, Punkt 4 verworfen. Duplizieren trägt Verweise (Gruppe, Tags, Login-Set, Jump) und **kein** Geheimnis — auch nicht das eigene `secretID` des Jumps, das ein anderes Fach ist. Das Drei-Punkte-Menü trägt drei Sheets; sein Wächter zählt sie nicht mehr auf, sondern findet sie. **Offen nur noch: Punkt 2** — Facetten-Schnellfilter unter der Suche in Known-Hosts, Keys und Logins. |
