...
**Spec:** `docs/superpowers/specs/2026-08-08-m25-placeholder-reader-design.md`
...
| `docs/superpowers/specs/2026-08-08-m25-closeout.md` | closing report | 4 |
...
- Create: `docs/superpowers/specs/2026-08-08-m25-closeout.md`
...
`docs/superpowers/specs/2026-08-08-m25-closeout.md`, copy the shape of
`2026-08-08-m24-closeout.md`. Must contain: the verification (test counts,
...
```bash
git add docs/superpowers/specs/2026-08-08-m25-closeout.md
