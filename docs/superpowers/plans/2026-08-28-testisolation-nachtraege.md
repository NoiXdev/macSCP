...
**Basis:** `docs/superpowers/specs/2026-08-22-backlog-testisolation.md` — that entry is also the design; it names the finding and the fix for each of the three follow-ups.
