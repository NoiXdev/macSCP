...
struct ConnectionDiagnosticsTests {
    ...
    @Test func cancellationMidRunEndsWithTheStepsSoFarAndSaysItWasCancelled() async throws {
        ...
        let diagnostics = ConnectionDiagnostics(
            ...
            internetSpeed: DiagnosticInternetSpeedSettings(service: .off), stepTimeout: .seconds(30))
    ...
    func theScopesThatResolveASecretAreTheOnesThatAskForOne(
        ...
        let diagnostics = ConnectionDiagnostics(
            ...
            throughput: DiagnosticThroughputSettings(),
            internetSpeed: DiagnosticInternetSpeedSettings(service: .off), appVersion: "test")
    ...
    @Test func theSSHDialNeverPutsTheSecretInTheReport() async throws {
        ...
        let report = await ConnectionDiagnostics(
            ...
            throughput: DiagnosticThroughputSettings(),
            internetSpeed: DiagnosticInternetSpeedSettings(service: .off), stepTimeout: .seconds(10)
        ).run()
    ...
    private static func run(
        ...
        await ConnectionDiagnostics(
            ...
            throughput: DiagnosticThroughputSettings(),
            internetSpeed: DiagnosticInternetSpeedSettings(service: .off), stepTimeout: stepTimeout,
